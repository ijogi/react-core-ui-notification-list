'use strict';var _createClass=function(){function a(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,'value'in c&&(c.writable=!0),Object.defineProperty(a,c.key,c)}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),_react=require('react'),_react2=_interopRequireDefault(_react),_reactRouterDom=require('react-router-dom'),_propTypes=require('prop-types'),_propTypes2=_interopRequireDefault(_propTypes);Object.defineProperty(exports,'__esModule',{value:!0}),exports.NotificationListItemPreview=exports.NotificationListItem=exports.NotificationList=void 0;require('./styles.css');var _reactstrap=require('reactstrap');function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _defineProperty(a,b,c){return b in a?Object.defineProperty(a,b,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[b]=c,a}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError('Cannot call a class as a function')}function _possibleConstructorReturn(a,b){if(!a)throw new ReferenceError('this hasn\'t been initialised - super() hasn\'t been called');return b&&('object'==typeof b||'function'==typeof b)?b:a}function _inherits(a,b){if('function'!=typeof b&&null!==b)throw new TypeError('Super expression must either be null or a function, not '+typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}}),b&&(Object.setPrototypeOf?Object.setPrototypeOf(a,b):a.__proto__=b)}var NotificationList=exports.NotificationList=function(a){function b(a){_classCallCheck(this,b);var c=_possibleConstructorReturn(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,a));_initialiseProps.call(c);var d=c.props,e=d.defaultSortBy,f=d.items;return c.state={sortBy:e||'date',sortDesc:!1,filteredItems:f,isSortingDropdownOpen:!1,isFilteringDropdownOpen:!1,successMessage:null,errorMessage:null},c}/**
     ...
     * @param {Object} item - Notification list item.
     * @return {Object} JSX code for action buttons with onClick event handlers.
     */value:function renderDropdownItem(a){var b=this;if(a.type&&a.type.actions)return _react2.default.createElement('div',null,a.type.actions.map(function(c){return _react2.default.createElement(_reactstrap.Button,{key:c.icon,color:c.color,onClick:function onClick(){return b.handleAction(c.func,a)},style:{padding:'0.1rem'}},_react2.default.createElement('i',{className:c.icon}),' ',c.name)}))}/**
     * Renders an item preview in the dropdown list
     * @param {Object} item - Notification list item.
     * @return {Object} JSX code notification list item preview.
     */},{key:'renderPreviewDropdownItem',value:function renderPreviewDropdownItem(a){var b=this.state,c=b.successMessage,d=b.errorMessage,e=this.props.truncateTextLength;if(a.type&&a.type.actions)return _react2.default.createElement(_reactstrap.DropdownItem,{style:{border:'none'}},_react2.default.createElement('div',null,!!a.sender&&!!a.sender.avatarUrl&&_react2.default.createElement('div',{className:'avatar float-left',style:{margin:'10px 5px 10px -10px'}},_react2.default.createElement('img',{src:a.sender.avatarUrl,className:'img-avatar',alt:'avatar'}))),_react2.default.createElement('div',null,_react2.default.createElement('div',null,_react2.default.createElement('small',{className:'text-muted'},a.sender?a.sender.firstName+' '+a.sender.lastName:''),_react2.default.createElement('small',{className:'text-muted float-right mt-1'},a.date?a.date.displayDate:'')),_react2.default.createElement('div',{className:'text-truncate font-weight-bold'},_react2.default.createElement('span',{className:a.type?a.type.icon:''}),' ',a.title),_react2.default.createElement('div',{className:'small text-muted text-truncate'},a.text.length>e?this.truncateText(a.text,e):a.text)),c&&_react2.default.createElement('p',{className:'text-success description animated fadeIn'},c),d&&_react2.default.createElement('p',{className:'text-danger description animated fadeIn'},d))}/**
     * Components render fucntion
     * @return {Object} JSX code for Notification list item.
     */},{key:'render',value:function render(){var a=this.props.item;return _react2.default.createElement('div',{className:'message',style:{borderBottom:'1px solid #c2cfd6'}},a.url?_react2.default.createElement(_reactRouterDom.Link,{to:a.url},this.renderPreviewDropdownItem(a)):this.renderPreviewDropdownItem(a),_react2.default.createElement(_reactstrap.ButtonGroup,{size:'sm',style:{padding:'0.1rem 0.5rem'},className:'message'},this.renderDropdownItem(a)))}}]),b}(_react.PureComponent);NotificationListItemPreview.propTypes={item:_propTypes2.default.object.isRequired,truncateTextLength:_propTypes2.default.number.isRequired};