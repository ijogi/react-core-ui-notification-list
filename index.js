    ...
    _createClass(NotificationListItem, [{
        ...
        value: function renderListItem(item, priorityClasses, truncateTextLength) {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _reactstrap.CardHeader,
                    { style: { padding: '0.3rem 0.7rem', borderBottom: 'none' }, className: !!item.category ? item.category.cssClass : '' },
                    _react2.default.createElement(
                        'div',
                        { className: 'header', style: { margin: '0' } },
                        _react2.default.createElement(
                            'span',
                            { className: 'from' },
                            ...
                            item.alert && _react2.default.createElement(
                                _reactstrap.Alert,
                                { color: item.alert.color, style: { padding: '0.2rem 0.3rem' } },
                                item.alert.text
                            )
                        )
                    )
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            item.sender && item.sender.avatarUrl && _react2.default.createElement(
                                _reactstrap.Media,
                                null,
                                _react2.default.createElement(_reactstrap.Media, { object: true, src: item.sender.avatarUrl, alt: 'Client avatar', className: 'img-avatar', style: { height: '3.5rem' } })
                            ),
                            _react2.default.createElement(
                                _reactstrap.Media,
                                { body: true },
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'span',
                                        { className: 'description date', style: { float: 'right' } },
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'li',
                { className: (item.category && item.category.cssClass ? item.category.cssClass : 'x') && (item.isRead ? "message unread" : "message"), style: { cursor: 'default', padding: '0' } },
                _react2.default.createElement(
                    _reactstrap.Card,
                    { style: { border: 'none' } },
